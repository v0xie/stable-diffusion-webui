...
options_templates.update(options_section(('optimizations', "Optimizations", "sd"), {
    ...
    "entmax_attn_temp": OptionInfo(1.0, "Entmax attention temperature", gr.Slider, {"minimum": 0.01, "maximum": 2.0, "step": 0.01}, infotext='Temperature').info("control temperature scale when using entmax attention."),
}))
